...
- Mostly for applications other than metadata (e.g. network analysis)
...
## Details depend on format and software

- Special properties (name, id, visual attributes, reserved words...)

- Which datatypes are supported (string, number, date...)?

- Can properties have values of mixed type? Empty set? Null-values?
...
```{mermaid}
flowchart LR
  Q28193["Academy Award for Best Film Editing (Q28193)<br>alias: Oscar for Best Film Editing"]
  Q463119["Marcia Lucas (Q463119)<br><tt>alias:</tt> Marcia Griffin"]
...
- data model and terminology differs from both RDF and common property graphs
